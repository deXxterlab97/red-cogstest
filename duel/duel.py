...
WEAPONS = {
    ...
    'fire': {
        ...
        'ballistic missile': 6,
        'water gun': 1,
        'flying spaghetti monster': 3,
        'Nuclear Missile': 1000,
        'rocket propelled grenade': 6,
        'pen gun': 2,
        'bow': 3,
        'slingshot': 4,
        'Spaceballs: The Flamethrower': 9,
    },
    'stab': {
        'naginata': 5,
        'lance': 4,
...
SINGLE_PROJECTILE = {
    ...
    'hurl': {
        ...
        'a spear': 6,
        'a heavy rock': 3,
        'the official Lego UCS Millenium Falcon set': 4,
        'a giant fucking bolder': 7,
        'American Airlines Flight 11': 14,
    },
    'toss': {
        'a molotov cocktail': 4,
        'a grenade': 5,
        'a sex doll': 4,
        'a hot potato': 3,
        'your mom': 8,
        'a chair': 4,
        'their phone': 2,
        'their mint 1933 Joeseph Stalin Commemorative Plate Set': 5,
    }
}
...
FAMILIAR = {
    'divebomb': {
        ...
        'their porg friend': 3,
        'their Douglas SBD Dauntless Dive Bomber': 8,
    },
    'charge': {
        'their pet goat': 3,
        'their pet unicorn': 4,
        'their firstborn child': 3,
    },
    'constrict': {
...
SUMMON = {
    'charge': {
        'a badass tiger': 5,
        'a sharknado': 8,
        'force ghost Obi-Wan': 10,
        'a starving komodo dragon': 5,
        'their mom': 6,
        'a five year old kid': 2,
    },
    'swarm': {
...
BODYPARTS = [
    ...
    'other vagina',
    'lungs',
    'Official Lego Star Wars Millenium Falcon',
    'fake silicon boobs'
]

VERB_IND_SUB = {'munch': 'munches', 'toss': 'tosses', 'force push': 'force pushes', 'punch': 'punches'}
...
CRITICAL = {"Quicker than the eye can follow, {a} delivers a devastating blow with their {o} to {d}'s {b}.": WEAPONS,
            ...
            "{a} gets to the high ground and yell 'It's over!' and hit {d} in a 360 no scope right to the {b} with their {o}. Critical hit!": WEAPONS,
            "Surprise motherfuckers!": MARTIAL,
            "{a} orders Grand Moff Tarkin to fire Death Star towards {d}. Critical hit!": WEAPONS,
            }
...
HEALS = {
    ...
    'drink': {
        'some': {
            ...
            'sizzurp': 4,
            'goon wine': 3,
            'fuck you {d} juice': 1000
        },
        'a': {
            'generic hp potion': 5,
            'refreshingly delicious can of 7-Up': 5,
            'fresh mug of ale': 4
        },
        'an': {
            'elixir': 5
...
HEAL = {"{a} decides to {v} {o} instead of attacking.": HEALS,
        ...
        "{a} uses jedi force heal.": 7,
        "{d} accidentally tosses a potion of healing at {a}.": 5,
        }


FUMBLE = {"{a} {v} their {o} at {d}, but has sweaty hands and loses their grip, hitting themself instead.": indicatize(WEAPONS),
          "{a} {v} their {o}, but fumbles and drops it on their {b}!": indicatize(WEAPONS),
          "{a} didn't pay {o} enough money and are attacked instead!": indicatize(SUMMON)
          }
MISS = {"{a} closes in on {d}, but suddenly remembers a funny joke and laughs instead.": 0,
          "{a} moves in to attack {d}, but is disctracted by a shiny.": 0,
          "{a} attempts to attack {d} but chickens out as they hear Imperial March playing in the background.": 0,
          "{a} misses {d} by a mile and blames lag.": 0,
        }
