...
__version__ = "3.4.12"
log = logging.getLogger("red.vrt.canhunting")


class CanHunting(commands.Cog):
    """Canadian Hunting, it hunts birds and things that fly."""
